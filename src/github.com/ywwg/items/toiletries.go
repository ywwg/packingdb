...
var toiletries = []plib.Item{
	...
	plib.NewTemperatureItem("spray sunscreen", 70, 120, []string{"Camping", "Bright", "Hiking"}, []string{"Flight"}),
	plib.NewTemperatureItem("regular sunscreen", 70, 120, []string{"Camping", "Bright", "Hiking"}, nil),
	plib.NewTemperatureItem("lip sunscreen", 70, 120, []string{"Camping", "Bright", "Hiking"}, nil),
