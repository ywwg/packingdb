...
var clothing = []plib.Item{
	...
	plib.NewConsumableMaxTemperatureItem("short socks", 1.0, 4.0, "pair", 65, 120, nil, []string{"Camping"}),
	...
	plib.NewTemperatureItem("short pjs", 55, 120, nil, nil),
	plib.NewTemperatureItem("long pjs", 0, 55, nil, nil),
	plib.NewConsumableMaxItem("work jeans", 0.2, 2.0, "pair", []string{"Dirt"}, nil),
	...
	plib.NewConsumableMaxTemperatureItem("tshirts", 0.75, 4.0, plib.NoUnits, 65, 120, nil, nil),
