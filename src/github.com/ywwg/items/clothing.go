...
var clothing = []plib.Item{
	plib.NewBasicItem("boots", []string{"Dirt", "Snow", "Tiny House", "Skiing"}, nil),
	...
	plib.NewConsumableItem("smartwool socks", 1.0, "pair", []string{"Camping", "Tiny House", "Skiing"}, nil),
	...
	plib.NewConsumableTemperatureItem("underlayer top", 0.5, plib.NoUnits, 0, 50, []string{"Camping", "Skiing"}, nil),
	plib.NewConsumableTemperatureItem("underlayer bottom", 0.5, plib.NoUnits, 0, 50, []string{"Camping", "Skiing"}, nil),
